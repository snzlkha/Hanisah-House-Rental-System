        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">My Room Details</h4>
                </div>
...
<td><?php echo $dr = $row->duration;?> Months</td>
                                            ...
                                            <td>
                                            <?php if($row->garbagecollection==0){
                                            echo "Not Required";
                                            } else {
                                            echo "Required";
                                            }
                                            ...
                                            <?php if($row->garbagecollection==1){ 
                                            $fd=15; 
                                            echo 'RM'.(($fd+$fpm)*$dr);
                                            } else {
                                            echo 'RM'.$dr*$fpm;
                                            ...
                                            <?php echo $row->corresState;?>, <?php echo $row->corresPincode;?><br />
                                            ...
                                            <?php echo $row->pmntState;?>, <?php echo $row->pmntPincode;?><br />	
    										...
    										<td colspan="6" style="color: green; font-weight: bold;">Successful</td>
											</tr>
