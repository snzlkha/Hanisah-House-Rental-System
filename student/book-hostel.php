<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $seater=$_POST['seater'];
        $feespm=$_POST['fpm'];
        $garbagecollection=$_POST['garbagecollection'];
        ...
        $query="INSERT into  registration(roomno,seater,feespm,garbagecollection,stayfrom,duration,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresState,corresPincode,pmntAddress,pmntState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('iiiisisssssisissississi',$roomno,$seater,$feespm,$garbagecollection,$stayfrom,$duration,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$cstate,$cpincode,$paddress,$pstate,$ppincode);
        $stmt->execute();
...
<head>
    ...
    <title>Hanisah House Rental</title>
    <!-- Custom CSS -->
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Book House</h4>
                    </div>
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Garbage Collection</h4>
            <div class="custom-control custom-radio">
                <input type="radio" id="customRadio1" value="1" name="garbagecollection" class="custom-control-input">
                <label class="custom-control-label" for="customRadio1">Required <code>Extra RM15 Per Month</code></label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" id="customRadio2" value="0" name="garbagecollection" class="custom-control-input" checked>
...
<div class="col-sm-12 col-md-6 col-lg-4">
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                <input type="text" name="stayend" id="stayend" class="form-control" readonly>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.getElementById('duration').addEventListener('change', function() {
        var stayfrom = new Date(document.getElementById('stayf').value);
        var duration = parseInt(this.value);
        stayfrom.setMonth(stayfrom.getMonth() + duration);
        var stayend = stayfrom.toISOString().split('T')[0];
        document.getElementById('stayend').value = stayend;
    });
</script>
...
<div class="col-sm-12 col-md-6 col-lg-4">
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                <input type="text" name="fpm" id="fpm" placeholder="Your total fees" class="form-control" value="600" readonly>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.getElementById('duration').addEventListener('change', function() {
        var duration = parseInt(this.value);
        var totalFeesPerMonth = 600;
        var garbageCollectionFee = 15;
        var garbageCollection = document.querySelector('input[name="garbagecollection"]:checked').value;

        var totalAmount = (totalFeesPerMonth * duration) + (garbageCollectionFee * duration);
        if (garbageCollection === '0') {
            totalAmount = totalFeesPerMonth * duration;
        }
        ...
        document.getElementById('ta').value = totalAmount.toFixed(2);
                ...
                <h4 class="card-title mt-5">Guardian's Information</h4>
					...
					<h5 class="card-title mt-5">Payment</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Card Number</h4>
                                        <div class="form-group">
                                            <input type="text" name="cardnum" id="cardnum" class="form-control" placeholder="Enter Card Number" required>
                                        </div>
                                </div>
                            </div>
                        </div>
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Card CVV</h4>
                                        <div class="form-group">
                                            <input type="text" name="cardcvv" id="cardcvv" class="form-control" placeholder="Enter Card CVV" required>
                                        </div>
                                </div>
                            </div>
                        </div>
					...
					<div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Card Holder Name</h4>
                                        <div class="form-group">
                                            <input type="text" name="cardholdername" id="cardholdername" class="form-control" placeholder="Enter Card Holder Name" required>
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">State</h4>
                                        <div class="form-group">
                                            <input type="text" name="pstate" id="pstate" class="form-control" placeholder="Enter State Name" required>
                                        </div>
                                </div>
                            </div>
                        </div>
