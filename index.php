    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(assets/images/rumah.jpg);">
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
								 ...
								 <div class="col-lg-12 text-center mt-4">
                                   <a href="register-student.php" class="text-primary">Register Student Account</a>
                                </div>
                                <div class="col-lg-12 text-center mt-2">
                                   <a href="admin/index.php" class="text-primary">Go to Admin Panel</a>
                                </div>
                            </div>
                        </form>
                    </div>
